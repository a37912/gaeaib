(function($)
{
     ...
     * Copyright (c) 2010 Winry Rockbell <winry@gaech.org>
    ...
    var __ = function (str, value, settings)
    {
        if($.easydate.__) {
          return $.easydate.__(str, value, settings);
        }
    ...
    function get_date(element, settings)
    {
        ...
        if(isNaN(date))
        {
            ...
            var stamp = parseInt(element.attr("datetime"));
    ...
    $.fn.easydate = function(options)
    {
        ...
        this.each(function()
        {
            ...
            if(!isNaN(updates[element_id]))
            {
                console.log("found " + updates[element_id]);
                clearTimeout(updates[element_id]);
                delete updates[element_id];
            }
            */
